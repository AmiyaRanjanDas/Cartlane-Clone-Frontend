...
const Products = (props) => {
  const { id, title, price, desc, image, rating,func ,funct } = props;
              ...
              <div className="row" style={{ justifyContent: "center" }}>
                ...
                <div className="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                  ...
                  <div className="d-flex flex-column mt-4">
                    <button className="btn btn-sm" type="button" style={{ background: "pink" }} onClick={funct}>
                      Details
                    </button>
                    <button className="btn btn-pink btn-sm mt-2"  type="button"  onClick={func} > Add to cart  </button>
                  </div>
                </div>
              </div>
            </div>
